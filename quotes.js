const QUOTESBANK=[
			{
				quote:"Learn balance Daniel San... Wax-on... Wax-off",
				author: "Miyagi"
			},
			{
				quote:"No such thing as bad student,only bad teacher.",
				author: "Miyagi"
			},
			{
			...
			{
				quote:"Strike first, no mercy? Real good lessons. If you think I'm gonna let you fill these kids heads with that garbage, you're nuts, man.",
